...
print("Pruebas del logger con la funcion built-in mkdir")

comandos = ["mkdir","mkdir 1234","mkdir 1234","cd /","mkdir 12345","cd /home/asd","ver_logs", "ver_errores", "exit"] #Commandos a ejecutar
